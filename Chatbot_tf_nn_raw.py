...
####In this section we write the function that will feed last generated 
...
##Feel free to test any sentence using tf.eval or tf.run, you will need to change 
## the fd to your input, make sure to convert the string to integers from 
## the function I have written
##I am working on an interactive surface for users
